...
namespace sprite
{
    #region .Net3.5 not support 32bit program read 64bit os regedit
    class ReadRegedit
    {
    ...
    #endregion
    //RegistryKey localMachine = ReadRegedit.OpenBaseKey(RegistryHive.LocalMachine, is64BitOS?ReadRegedit.RegistryHiveType.X64 : ReadRegedit.RegistryHiveType.X86);
    //RegistryKey key = localMachine.OpenSubKey(mySubKeyName, true);
}
